...
var button = renderer.create('<button type="button" class="note-btn" role="button" >', function ($node, options) {
    // set button type
...
var dialog = renderer.create('<div class="note-modal" aria-hidden="false"  role="dialog"/>', function ($node, options) {
    if (options.fade) {
        $node.addClass('fade');
    }
    $node.attr({
